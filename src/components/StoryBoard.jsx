...
import Dune from './Img/DuneV2.jpg';
  ...
  return (
    <>
      <div className='storyboard'>
        <div style={carcosaBackground}>
          <h1 style={{padding: '3rem', marginTop: '0rem'}}>The Road to Carcosa</h1>
          ...
          <div className='places-card' style = {cardStyle}>
            <div className='prologue'>
              ...
              <p>
                ...
                <em>"Nothing left"</em>, Ibram mumbled, eyeing the willowy dead. 
                ...
                <em>"How could that be?"</em> he wondered.
              </p>
              <p>
                The rest of the journey was uneventful. The dark waters of the Sabian Sea crept closer as they marched toward the port town. Their arrival in Carcosa was clearly foreseen but evidently not with much enthusiasm. They approached from the south and Ibram noted the feeble stick palisade, dour minutemen staring out from rickety watchtowers. The gate was little more than raw timber, he judged a few men could smash it down. Oddly poor defenses for such a hostile frontier. 
